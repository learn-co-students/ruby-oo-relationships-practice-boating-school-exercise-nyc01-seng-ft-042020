...
instruct1 = Instructor.new("Ms.Puff")
instruct2 = Instructor.new("Mr.Krabs")
 
no_crashing = student1.add_boating_test("Don't Crash 101", "pending", instruct1)
power_steering_failure = student2.add_boating_test("Power Steering 202", "failed", instruct1)
power_steering_pass = student2.add_boating_test("Power Steering 201", "passed", instruct2)
